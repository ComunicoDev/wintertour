	...
	<form class="wintertour_register" method="post">
		...
		<table style="width:100%;">
			<tbody>
				...
				<tr><td><label for="datanascita">Data di Nascita: </label></td><td><input autocomplete="off" required="required" name="datanascita" type="text" placeholder="gg/mm/aaaa" pattern="\d\d\/\d\d/\d{4}" /></td></tr>
